"use client";
import { Avatar, Link, Button, Card, useDisclosure } from "@nextui-org/react";
  ...
  return (
    <>
      <div className="w-full rounded-none p-2 lg:flex lg:flex-row z-10 bg-app-white md:px-8">
        <div className="max-h-[250px] w-full lg:max-w-[500px] overflow-hidden flex justify-center items-center rounded-xl mb-4 relative">
          ...
          <div
            className={`absolute bottom-0 right-0 text-white lg:hidden ${
        ...
        <div className="lg:ml-4 block lg:flex flex-col justify-between w-full">
            ...
            <div className="flex justify-start items-center">
              ...
              <div className="flex flex-col items-start justify-center">
                <Link className="cursor-pointer text-black hover:text-app-green transition-all duration-150">
                  <h4 className="text-4xl font-bold text-center ml-2">
                    {title}
                  </h4>
                </Link>
                <Link className="cursor-pointer">
          ...
          <div className="flex justify-between items-center ml-12 mt-1">
            ...
            <div className="flex justify-end items-center mr-2 gap-2">
              ...
              <Button isIconOnly variant="faded" className="border-none" onClick={onOpen}>
      ...
      <CommentModal isOpen={isOpen} onOpenChange={onOpenChange} onOpen={onOpen}/>
    </>
  );
};
